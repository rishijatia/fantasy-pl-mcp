...
from fpl.cache import cache, cached
from fpl.rate_limiter import RateLimiter

# Add the parent directory to sys.path to ensure we can import the config
import sys
import pathlib
server_dir = str(pathlib.Path(__file__).parent.parent.absolute())
if server_dir not in sys.path:
    sys.path.insert(0, server_dir)

# Now we can import the config
from config import (
    FPL_API_BASE_URL, 
    FPL_USER_AGENT, 
    STATIC_SCHEMA_PATH, 
